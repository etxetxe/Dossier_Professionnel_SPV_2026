...
Comment le système embarqué marche. Chaque espace de travail introduit des variables de remplacement dans leurs fichiers markdown. L'agent embarqué les remplacent par le contenu réel envoyé par l'utilisateur via le déclencheur `démarrer`.
